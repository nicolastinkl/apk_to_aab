...
# java -jar bundletool-all-1.6.1.jar dump manifest --bundle apk/Casino_Mania_777/1e1a514e282139b39d2ea0197309fd47.20230620155216.apk_signed_2023-06-20_15_57_10.aab --xpath /manifest/@android:versionName
...
if [ -z "$first_file" ]; then
    ...
    python.exe bundletool.py -i  ${input_path}  -o ${des_path} --keystore ${first_file}  --store_password BlackJackPoker1!@# --key_alias  BlackJackPoker  --key_password   BlackJackPoker1!@#
